...
from utils import chat, add_user_message, add_assistant_message, generate_prompt_evaluation_report

# PromptEvaluator Implementation
class PromptEvaluator:
    def __init__(self, api_key, max_concurrent_tasks=3):
    ...
    def generate_unique_ideas(self, task_description, prompt_inputs_spec, num_cases):
        ...
        for key in prompt_inputs_spec:
            # val = value.replace("\n", "\\n")
            example_prompt_inputs += f'"{key}": str,'
